...
func TestAddComment(t *testing.T) {
	...
	err := AddComment(db, workout.ID, "This is a test comment")
	if err != nil {
...
func TestMarkWorkoutCompleted(t *testing.T) {
	...
	err := MarkWorkoutCompleted(db, workout.ID)
	if err != nil {
...
func TestGetAllWorkouts(t *testing.T) {
	...
	workouts, err := GetAllWorkouts(db, user.ID, "")
	if err != nil {
...
func TestGetWorkoutByName(t *testing.T) {
	...
	retrievedWorkout, err := GetWorkoutByName(db, user.ID, "My Test Workout")
	if err != nil {
